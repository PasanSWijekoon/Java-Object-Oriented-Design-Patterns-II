...
public class CalPro {
    public static void main(String[] args) {
        ...
        Expression ex2 = new MultiplyExpression(new AddExpression(new NumberExpression(2), new NumberExpression(3)),
                new NumberExpression(4));
        System.out.println("MUL(ADD(2, 3), 4) = " + ex2.interpret(context));

        Expression ex3 = new DivisonExpression(
                new SubtractExpression(new NumberExpression(20), new NumberExpression(4)), new NumberExpression(2));
        System.out.println("DIV(20, 4),2)= " + ex3.interpret(context));

        Expression ex4 = new PowerExpression(new NumberExpression(2), new NumberExpression(3));
        System.out.println("POW(2, 3) = " + ex4.interpret(context)); // Output: 8
    }
}
